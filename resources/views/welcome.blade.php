            ...
            <div x-data={open:false} class="relative bg-white">
                <div
                    ...
                    <div class="flex justify-start gap-5 items-center lg:w-0 lg:flex-1">
                        ...
                        <span
                            class="text-xl font-bold  uppercase">{{ \App\Models\Websetting::first()->page_title }}</span>
                                ...
                                "
                                    ...
                                    <div>
                                        <p class="text-sm text-gray-500">
                                            <time>{{ date('F jS, Y', strtotime($page->created_at)) }}</time>
                                        </p>
                                        <a href="{{ route('page.show', $page->id) }}" class="mt-2 block">
                                            <p class="text-xl font-semibold text-gray-900">{{ $page->title }}</p>
                                            <p class="mt-3 text-base text-gray-500">{{ $page->subtitle }}
                                            </p>
                                        </a>
                                        <div class="mt-3">
